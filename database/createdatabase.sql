...
insert into product values(3,'MIXED-MATERIAL TRAINERS WITH SUEDE AND FAUX LEATHER','Shoes','Sneakers',1900,'https://images.hugoboss.com/is/image/boss/hbeu50498265_401_200','Lace-up trainers by BOSS, designed in mixed materials with suede trims, faux nappa leather and an odour-control lining.LacesFully linedPackaging: Box');
insert into product values(4,'Portuguese-crafted moccasin loafers in suede with penny trim','Shoes','Casual Shoes',2600,'https://images.hugoboss.com/is/image/boss/hbeu50541750_260_200','Crafted in soft suede for comfort, these timeless BOSS Menswear loafers have a flexible moccasin construction with great traction. Penny trim featuring embossed logo. We continuously look for more responsible ways to produce and finish our products. A minimum of 60% of the leather used to make this product has been sourced from certified tanneries. Fastening top: Slip-onFully linedPackaging: Box');
insert into product values(5,'REGULAR-FIT T-SHIRT IN STRETCH COTTON WITH CONTRAST LOGO','Clothing','T-shirts',680,'https://images.hugoboss.com/is/image/boss/hbeu50506373_027_100','An understated T-shirt by BOSS, ready to be teamed with any outfit. Regular fit in stretch cotton for comfort. Contrast logo at the chest.Regular fitCrew neckShort sleevesStandard length');
insert into product values(6,'Cotton-piqué polo shirt with logo detail','Clothing','Polo Shirts',1250,'https://images.hugoboss.com/is/image/boss/hbeu50494697_002_100','Crafted in breathable cotton piqué, this BOSS Menswear polo shirt is a versatile staple. Cut to a straight fit. Elegant tipping stripes.Regular fitPolo collarNumber of buttons: 3Short sleevesStandard length');
...
insert into product values(18,'Slim-fit pencil skirt in virgin wool','Clothing','Skirts',2000,'https://images.hugoboss.com/is/image/boss/hbeu50490036_001_100','An elegant pencil skirt by BOSS. Cut to a flattering slim fit with a high waist, its designed in soft wool with smooth lining. This product is made with responsibly sourced wool. For us, responsibly sourced means mulesing free, and meeting the standards of the Five Freedoms of animal welfare.Slim fitHigh risePencil skirtZip closureBack ventBack slitFully linedMedium lengthFit back length: 58 cm');
insert into product values(19,'Pencil skirt with zipped pockets in stretch material','Clothing','Skirts',2300,'https://images.hugoboss.com/is/image/boss/hbeu50533419_001_100','A modern pencil skirt by BOSS Womenswear. This fully lined piece is crafted in stretch material and trimmed with diagonal zipped pockets. This product is made with cellulose fibres, derived from natural raw wood material and sourced from responsibly managed forests. We cooperate with external organisations to ensure respectful treatment of virgin and endangered forests.Regular fitZip closurePockets bottom front: Zip pocketsBack slitFit back length: 62 cm');
